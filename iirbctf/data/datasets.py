...
class Fashion200k(BaseDataset):
    ...
    def __init__(self, path, split="train", transform=None):
        ...
        label_files = [f for f in listdir(label_path) if isfile(join(label_path, f))]
...
class FashionIQ(BaseDataset):
    ...
    def __init__(self, path, split="train", cat_type="all", transform=None):
        ...
        val_caps = ["cap.dress.val.json", "cap.shirt.val.json", "cap.toptee.val.json"]
    ...
    def __getitem__(self, idx):
        d = {
            ...
            "mod": {"str": self.imgs[idx]["captions"]},
        }
